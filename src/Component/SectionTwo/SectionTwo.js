...
const SectionTwo = () => {
  return (
    <section className="section_one sec_1_main_page  position-relative section_gap">
      <div className="container">
        ...
        <div className="row sec_1_info d-flex justify-content-center align-items-center">
          <div className="col" data-aos="fade-left">
            <div className="sec_1_box_info d-flex justify-content-center align-items-center">
              <div className="sec_1_box_info_body">
                <h4 className="sec_1_box_info_title text-center">
                  1-Month security deposit
                </h4>
                <img src={Assets.deposit_img} alt="deposit" width={150} />
                <p className="sec_1_box_info_text text-center font">
